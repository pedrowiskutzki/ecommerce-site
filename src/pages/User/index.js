                ...
                <>
                    <AccountCard>
                        ...
                        <AccountForm openForm={openForm}>
                            <h3>Nome</h3>
                            <input name="newName" placeholder="Alterar nome"></input>
                            <h3>Email</h3>
                            <input name="newEmail" type={"email"} placeholder="Alterar email"></input>
                            <h3>Senha</h3>
                            <input name="newPassword" type={"password"} placeholder="Alterar senha"></input>

                            <h3>Validação de usuário</h3>
                            <input name="checkPassword" required type={"password"} placeholder="Digite sua senha antiga"></input>
